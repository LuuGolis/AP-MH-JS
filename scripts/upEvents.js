...
buscador.addEventListener('keyup',()=>{
    let filtro = eventosFuturos.filter((event) => event.name.toLowerCase().includes(buscador.value.toLowerCase()))
...
buscador.addEventListener('keyup',()=>{
    let filtro = eventosFuturos.filter((event) => event.description.toLowerCase().includes(buscador.value.toLowerCase()))
