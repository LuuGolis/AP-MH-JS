...
let tarjetasCreadas = crearTarjetas(eventosPasados)
...
buscador.addEventListener('keyup',()=>{
    let filtro = eventosPasados.filter((event) => event.name.toLowerCase().includes(buscador.value.toLowerCase()))
...
buscador.addEventListener('keyup',()=>{
    let filtro = eventosPasados.filter((event) => event.description.toLowerCase().includes(buscador.value.toLowerCase()))
